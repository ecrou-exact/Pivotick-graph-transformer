...
export function renderSiteHeader(activePage: 'home' | 'demo' | 'docs'): void {
  ...
  header.innerHTML = `
    <a class="site-header-brand" href="./home.html">
    ...
    <nav class="site-header-nav" aria-label="Main">
      <a href="./home.html" ${activePage === 'home' ? 'class="active" aria-current="page"' : ''}>Home</a>
      <a href="./docs.html" ${activePage === 'docs' ? 'class="active" aria-current="page"' : ''}>Docs</a>
      <a href="./index.html" ${activePage === 'demo' ? 'class="active" aria-current="page"' : ''}>Demo</a>
