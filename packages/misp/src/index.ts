...
import { MispIndicatorCorrelationConverter } from './variants/indicator-correlation/IndicatorCorrelationConverter.js'
...
export {
  MispEventRootConverter,
  MispEventRootSimplifiedConverter,
  MispEventRootOverviewConverter,
  MispEventRootMinimalConverter,
  MispIndicatorCorrelationConverter,
}
...
ConverterRegistry.register(new MispIndicatorCorrelationConverter())
